...
//    TIMING_ID_DELETE_SIGNAL,
    ...
    TIMING_ID_ADD_BUS,
    TIMING_ID_EDIT,
    TIMING_ID_DISCONTINUITY,
    TIMING_ID_RULER,
    TIMING_ID_HORIZONTALARROW,
    TIMING_ID_EDITTEXT,
    ...
    TIMING_ID_PANEL_AXIS_MARKERLENGTH,
    TIMING_ID_PANEL_AXIS_TOTALLENGTH,
    TIMING_ID_PANEL_AXIS_OFFSET,

    TIMING_ID_PANEL_TC_APPLY,
    TIMING_ID_PANEL_TC_TXTFIELD,

    TIMING_ID_MENUITEM_CLOCK_TYPE,
    TIMING_ID_MENUITEM_TIME_COMPRESSOR,
    TIMING_ID_MENUITEM_AXIS_TIME,
    TIMING_ID_MENUITEM_TRANSITION,
    //TIMING_ID_MENUITEM_PANELS,
    TIMING_ID_MENUITEM_DEFAULT,
